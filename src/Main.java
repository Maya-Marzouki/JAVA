...
public class Main {
    public static void main(String[] args) {
        ...
        Employe e1=new Employe(1,"Marzouki","Maya","Informatique",2);
        Employe e2=new Employe(2,"Teb","Hela","RH",1);
        Employe e3=new Employe(3,"Bella","Lella","Cosmetique",3);
        Employe e4=new Employe(4,"lala","loulou","marketing",4);
        ...
        System.out.println("Liste des employes aprés le tri par ID");
        list.displayEmploye();
        list.trierEmployeParNomDepartementEtGrade();
        System.out.println("Liste des employes aprés le tri par département et grade");
        list.displayEmploye();
        list.supprimerEmploye(e4);
        System.out.println("Liste des employes aprés la suppression");
        list.displayEmploye();
    }
}
