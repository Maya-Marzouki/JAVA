public class Zoo {
    ...
    public void addAquaticAnimal(Aquatic aquatic){
        boolean test=false;
        int i=0;
        while(!test && i<this.aquaticAnimals.length) {
            if (this.aquaticAnimals[i] == null) {
                this.aquaticAnimals[i] = aquatic;
                System.out.print("Ajout avec succès! \n");
                test = true;
            } else {
                i++;
    ...
    public void displayNumberOfAquaticsByType(){
        ...
        System.out.println("le nombre des penguins est: "+penguins);
        System.out.println("le nombre des dolphins est: "+dolphins);
    }
}
